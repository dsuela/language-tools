...
.. code-block:: json

    {
        ...
        "symfonyLsp.runtimeTimeout": 10.0,
...
trusted workspace.
``symfonyLsp.runtimeTimeout`` controls the maximum number of seconds allowed
for the project bridge while collecting runtime metadata. It defaults to
``10.0`` seconds.
